package com.spectrasonic.essentialZ.Utils;
...
public final class MessageUtils {
    ...
    public static final String PREFIX = "&7[&6&lEssential &c&lZ&7] &f&l»&r ";
    ...
    public static void sendPermissionMensagge(CommandSender sender){
